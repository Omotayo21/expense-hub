...
return (
  <>
    <div className=" text-center">
      <h2 className="text-green-700 underline mt-16  text-center font-bold lg:text-4xl sm:text-4xl ">
        LETS GET TO KNOW EXPENSE HUB
      </h2>
      <br />
      <p className="lg:px-24 lg:ml-24">
        ...
        financial freedom with the Expense Tracker
      </p>
    </div>
